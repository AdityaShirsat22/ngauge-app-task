...
ExhibitorDetails exhibitorDetailsFromJson(String str) => ExhibitorDetails.fromJson(json.decode(str));

String exhibitorDetailsToJson(ExhibitorDetails data) => json.encode(data.toJson());
...
class ExhibitorDetails {
    ...
    factory ExhibitorDetails.fromJson(Map<String, dynamic> json) => ExhibitorDetails(
        code: json["Code"],
